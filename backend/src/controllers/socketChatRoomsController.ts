...
import { newChatRoomType, joinChatRoomType } from "../types/chatRoomTypes.ts"

export const createChatRoom = async (data: newChatRoomType, username: string) => {
...
export const joinChatRoom = async (data: joinChatRoomType, username: string) => {
